...
class UserController extends Controller
{
    ...
    public function store(UserRequest $req)
    {
        ...
        // icomment nalang ni pag naay bug
        $data['username'] = $uname = ($user_is_teamSA) ? $req->username : ucwords($req->username);
        ...
        if($user_is_staff){
            ...
            $d2['user_id'] = $user->id;
            //mao ning bug sa ubos
            //$d2['code'] = $staff_id;
            //icomment lang ni pagnaay bug
            $d2['code'] = $user->username;
